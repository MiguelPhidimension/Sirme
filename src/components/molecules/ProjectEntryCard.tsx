...
export const ProjectEntryCard: React.FC<ProjectEntryCardProps> = ({
  ...
  if (isEditing) {
    return (
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-700 dark:to-slate-600 rounded-2xl border-2 border-blue-200 dark:border-slate-500 shadow-lg overflow-hidden">
  ...
  return (
    <div className="group relative bg-gradient-to-r from-white to-gray-50 dark:from-slate-800 dark:to-slate-700 rounded-2xl border border-gray-200 dark:border-slate-600 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
      {/* Header with role and date */}
      <div className="bg-gradient-to-r from-slate-50 to-gray-100 dark:from-slate-700 dark:to-slate-600 px-6 py-4 border-b border-gray-200 dark:border-slate-600">
            ...
            <div className="flex items-center space-x-4 mb-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Hours Logged</p>
                </div>
              </div>
