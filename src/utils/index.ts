import type { DailyTimeEntry, ProjectEntry, ValidationRules, EmployeeRole } from '~/types';
...
export class ValidationUtils {
   ...
   */
  static validateProjectHours(hours: number, rules: ValidationRules = ValidationUtils.defaultRules): string | null {
   ...
   */
  static validateWeeklyTotal(entries: DailyTimeEntry[], rules: ValidationRules = ValidationUtils.defaultRules): string | null {
...
export class DataUtils {
   ...
   */
  static calculateWeeklyProgress(totalHours: number, targetHours: number = 40): number {
   ...
   */
  static groupEntriesByWeek(entries: DailyTimeEntry[]): Record<string, DailyTimeEntry[]> {
